            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    "I've always been passionate about crafting and creating meaningful gifts. As someone who 
                    loves both beauty and functionality, I was frustrated by how quickly traditional bouquets 
                    would wilt and be forgotten."
                  </p>
                  <p>
                    "That's when the idea struck me – what if I could arrange everyday accessories and treats 
                ...
                <div className="mt-6">
                  <p className="font-semibold text-foreground">- Founder, MeSun Florisse</p>
                </div>
              </div>
            </div>
          </div>
